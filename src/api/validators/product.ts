...
export const createProductSchema = z.object({
    ...
    category: z.string().regex(/^[0-9a-fA-F]{24}$/, "Invalid Category ID").nullable().optional(),
    subcategory: z.string().regex(/^[0-9a-fA-F]{24}$/, "Invalid Subcategory ID").nullable().optional(),
...
export const updateProductSchema = z.object({
    ...
    subcategory: z.string().regex(/^[0-9a-fA-F]{24}$/).nullable().optional(),
